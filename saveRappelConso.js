fetch('https://data.economie.gouv.fr/api/explore/v2.1/catalog/datasets/rappelconso0/records?select=count(*)&group_by=categorie_de_produit&order_by=count(*)DESC&refine=date_de_publication%3A2024')
    ...
    .then(data => {
        ...
        console.log("newResultsCategorie", newResultsCategorie); //objet {cat produit : nombre d'occurences}
        ...
        console.log("percentages", percentages);// objet {cat produit : pourcentage}
        ...
        console.log("percentageEnDecimal", percentageEnDecimal)

        // Largeur et hauteur du graphique
        const width = 600;
        const height = 300;
        const margin = { top: 100, right: 20, bottom: 150, left: 40 };
